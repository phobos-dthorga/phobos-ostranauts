...
Current prepared Shipbreaker requires Auto Nav 0.19.0 and Framework 0.26.0.
Current prepared Agriculture requires Framework 0.26.0 for shared crew work and controls.
