...
| --- | --- | --- | --- |
| **Phobos Framework** | 0.18.0 | Shared construction, inventory, controls and saved state | Required by content mods; [author guide](docs/framework-author-guide.md) |
...
| **Phobos Agriculture** | 0.4.0 | Potato/lettuce cultivation, visible growth, water conduits and galley cooking | First gameplay candidate; [guide](docs/agriculture-player-guide.md) |
