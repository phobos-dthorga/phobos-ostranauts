...
operation. Auto Nav 0.5.0 includes short-range approaches below 5,000 km with closer
...
[validated saved-flight restoration](docs/auto-nav-persistence.md). These are prepared versions; use installer
