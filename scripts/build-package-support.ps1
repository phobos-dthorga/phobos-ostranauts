...
function Copy-PhobosPlayerGuides {
    ...
    foreach ($name in @(
        'player-guide', 'equipment-branding', 'installing-mods', 'equipment-economy', 'equipment-value-audit', 'auto-nav-instruments', 'auto-nav-docking', 'artwork-resolution-policy',
