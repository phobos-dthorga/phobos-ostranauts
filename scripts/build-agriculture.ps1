...
$package = New-PhobosPackage -RepoRoot $repoRoot -Id PhobosAgriculture -Readme 'docs/agriculture-player-guide.md' -ExtraDocs @('docs/agriculture-player-guide.md', 'docs/agriculture-first-slice.md', 'docs/agriculture-research.md', 'docs/agriculture-roadmap.md', 'docs/agriculture-implementation.md', 'docs/agriculture-living-visuals.md', 'docs/agriculture-loot.md', 'docs/agriculture-seed-production.md', 'docs/agriculture-treatment-economy.md', 'docs/agriculture-nutrient-production.md', 'docs/agriculture-nutrient-recovery.md', 'docs/asset-generation-policy.md')
