...
$package = New-PhobosPackage -RepoRoot $repoRoot -Id PhobosAgriculture -Readme 'docs/agriculture-player-guide.md' -ExtraDocs @('docs/agriculture-player-guide.md', 'docs/agriculture-first-slice.md', 'docs/agriculture-research.md', 'docs/agriculture-roadmap.md', 'docs/agriculture-implementation.md', 'docs/asset-generation-policy.md')
