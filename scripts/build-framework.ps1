...
$package = New-PhobosPackage -RepoRoot $repoRoot -Id PhobosFramework -Readme 'docs/framework-author-guide.md' -ExtraDocs @('docs/phobos-framework.md', 'docs/material-port-pairing.md', 'docs/equipment-economy.md', 'docs/equipment-value-audit.md', 'docs/vanilla-economy-audit.md', 'docs/shipbreaker-room-load-mitigation.md')
