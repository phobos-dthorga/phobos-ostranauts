...
Fails { & $installer @incomplete | Out-Null } 'Selected equipment requires Phobos Framework 0.19.0'
Fails { & $installer @incomplete -Mods AutoNav | Out-Null } 'Selected equipment requires Phobos Framework 0.15.0'
Fails { & $installer @incomplete -Mods Shipbreaker | Out-Null } 'Selected equipment requires Phobos Framework 0.19.0'
